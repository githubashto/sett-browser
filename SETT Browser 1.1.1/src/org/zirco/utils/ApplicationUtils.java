...
public class ApplicationUtils {
	...
	/**
	 * Load the SETTRender script if necessary.
	 * @param context The current context.
	 * @return The SETTRender script.
	 */
	public static String getSETTRenderNativeString(Context context) {
		if (mSETTRenderNativeString == null) {
			InputStream ism = context.getResources().openRawResource(R.raw.settrender_native);
			if (ism != null) {
				...
				mSETTRenderNativeString = sbr.toString();
			} else {        
				mSETTRenderNativeString = "";
			}
		}
		return mSETTRenderNativeString;
	}
	...
	public static String getSETTRenderLatinString(Context context) {
		if (mSETTRenderLatinString == null) {
			InputStream ism = context.getResources().openRawResource(R.raw.settrender_latin);
			if (ism != null) {
				StringBuilder sbr = new StringBuilder();
				String line;
